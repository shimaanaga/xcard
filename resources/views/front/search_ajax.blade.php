<div class="row">
    ...
    <input type="hidden" name="search_result" class="search_result" value="{{ $search }}">
        ...
        @foreach($products as $product)
            ...
            <div class="col-md-4 d-flex">
                <div class="single-item-wrapper small-item">
                    <div class="item-img">
                        <a href="{{ url('/product/'.$product->id) }}"><img src="{{ $product->main_image }}" alt="{{_i('Product Image')}}" class="img-fluid"></a>
                    </div>
