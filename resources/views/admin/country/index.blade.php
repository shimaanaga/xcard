...
'activePageName' => _i('All Countries'),
] )
@section('content')
                    ...
                    <form id="add_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        <div class="content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-round country_code" name="code" required="">
                                </div>
                            </div>
...
{{--                            </div>--}}
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control form-control-round country_logo" name="logo">
                                </div>
                            </div>
                    ...
                    <form id="edit_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Code') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-round edit_country_code" name="code" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Logo') }}</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control form-control-round edit_country_logo" name="logo">
                                </div>
                            </div>
