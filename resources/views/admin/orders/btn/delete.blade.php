...
{{--<a href="transferBank/{{$id}}/edit" class="btn btn-primary"><i class="ti-eye"></i></a>--}}
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('orders.destroy', $id) }}" data-id="{{$id}}" data-target="#custom-width-modal"><i class="ti-trash"></i> {{_i('delete')}}</a>
