                ...
                <div class="modal-body">
                    <form id="add_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        <div class="content">
                            ...
                            <div class="divider-text gap-top-45 gap-bottom-45">
                                <span>{{ _i('Bank Number') }}</span>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Bank Number') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="code" placeholder="{{ _i('Bank Number') }}" required>
                                </div>
                            </div>
                    ...
                    <form id="edit_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Bank Number') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control bank_number" name="code" placeholder="{{ _i('Bank Number') }}" required>
                                </div>
                            </div>
