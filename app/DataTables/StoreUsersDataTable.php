...
class StoreUsersDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="../store_user/'.$query->id.'/edit" class="btn btn-success"><i class="ti-pencil-alt"></i> ' ._i('Edit') .'</a>';
            })
    ...
    {
        return Admin::query()->orderByDesc('id')->where('guard','store');
    }
