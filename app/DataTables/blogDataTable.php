...
class blogDataTable extends DataTable
{
    ...
    {
        return $model->query()->select('blog_translations.title as title','blog_translations.content as content','blogs.id as id')
            ->leftJoin('blog_translations','blog_translations.blog_id','=','blogs.id')->where('locale',App::getLocale());
    }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                ...
                'buttons' => [
                    [
                        'text' => '<i class="ti-plus"></i> ' . _i('create new blog'),
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name'=>'blog_translations.title','data'=>'title','title'=>_i('title')],
